...
CREATE TABLE intern_cip_codes (
    cip_family INT NOT NULL,
    cip_code character varying NOT NULL,
    action text,
    text_change text,
    cip_title text NOT NULL,
    cip_definition text NOT NULL,
    cross_references text,
    examples text,
    PRIMARY KEY(cip_code)
);

CREATE INDEX intern_cip_codes_cip_family ON intern_cip_codes (cip_family);
...
CREATE TABLE intern_major (
       ...
       cip_code character varying REFERENCES intern_cip_codes(cip_code),
       PRIMARY KEY(id)
);
