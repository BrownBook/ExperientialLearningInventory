...
class SearchBox extends React.Component {
  ...
  componentDidMount() {
    const searchSuggestions = new Bloodhound({
      datumTokenizer: function (datum) {
        const nameTokens = Bloodhound.tokenizers.obj.whitespace('name');
        const studentIdTokens = Bloodhound.tokenizers.obj.whitespace('studentId');
        const usernameTokens = Bloodhound.tokenizers.obj.whitespace('email');
    ...
    const element = this.typeAheadRef.current;
    $(element).typeahead(
      {
        minLength: 3,
        highlight: true,
    ...
    const handleSearch = this.props.onSelect;
      ...
      <div>
        <div>
          <input
            ...
            placeholder="Banner ID, User name, or Full Name"
